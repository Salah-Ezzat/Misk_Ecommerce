<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <li><a class="nav-link" href="blank.html"><i class="fas fa-fire"></i> <span>الصفحة الرئيسية</span></a></li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="menu-header">الإعلانات</li>
        <li><a class="nav-link" href="{{ route('banners.index') }}"><i class="fas fa-tags"></i> <span>الإعلانات</span></a></li>
