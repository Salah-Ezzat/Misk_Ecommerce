            ...
            <div class="wsus__invoice_area">
                                    ...
                                    <tr>
                                        ...
                                        <td class="quentity">
                                            <div style="display: flex; align-items: center; gap: 5px;">
                                                <button type="button" class="btn btn-sm btn-light border quantity-decrease"
                                                    data-id="{{ $stock->id }}">-</button>

                                                <input type="number" min="0"
                                                    class="form-control text-center quantity-input" value="0"
                                                    name="quantity[]" style="width: 60px;" data-id="{{ $stock->id }}"
                                                    data-price="{{ $price }}" data-max="{{ $stock->max_limit }}" />


                                                <button type="button" class="btn btn-sm btn-light border quantity-increase"
                                                    data-id="{{ $stock->id }}">+</button>
                                            </div>
                                        </td>
                ...
                <div class="wsus__invoice_footer">
                    <p>
                        ...
                        <input type="text" id="invoiceTotal" value="" readonly class="form-control">
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <input type="text" id="finalTotal" name="invoice_total" value="" readonly class="form-control">
                    </p>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateInvoiceTotal() {
                ...
                if (invoiceTotal) {
                    invoiceTotal.value = sum.toFixed(2);
                }
