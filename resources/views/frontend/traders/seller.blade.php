                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="total_all_products" class="form-control" value="0.00" readonly>
                                    </td>
                                    <td></td>
                                </tr>
...
<div class="container mt-5">
    <div class="progress">
        <div id="purchaseProgressBar" class="progress-bar" role="progressbar" style="width: 0%;"
