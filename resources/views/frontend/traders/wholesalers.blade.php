    ...
    <div class="row">
        <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
            <div class="dashboard_content mt-2 mt-md-0">
                <h3><i class="fas fa-warehouse"></i> تجار جملة الجملة </h3>
                            ...
                            <div class="wsus__cart_list wishlist">
                                <div class="table-responsive">
                                    <table>
                                        <tbody>
                                            @if ($users->isEmpty())
                                            <div class="card text-center shadow-sm border-warning mt-4" style="max-width: 500px; margin: auto;">
                                                <div class="card-body">
                                                        ...
                                                        <div class="wsus__offer_det_single">
                                                            <div
                                                                ...
                                                                <div class="wsus__product_details overflow-hidden">
                                                                    ...
                                                                    <a href="{{ route('stocks.show', $user->id) }}"> <h5 class="mb-2 text-primary fw-bold"
                                                                        style="font-size: 18px;">
                                                                        <i class="fas fa-building"></i> {{ $user->shop }}
                                                                    </h5>
                                                                    </a>
